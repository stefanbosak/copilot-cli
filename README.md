...
[![Copilot](https://img.shields.io/badge/GitHub-Repository-blue?logo=github)](https://github.com/github/copilot-cli)
...
| Component | Version |
|-----------|---------|
| **GitHub Copilot CLI** | [`1.0.81-12`](https://github.com/github/copilot-cli/releases/tag/v1.0.81-12) |

> 🔄 Last updated: 2026-08-26T19:04:53Z · [Build #171](https://github.com/stefanbosak/copilot-cli/actions/runs/33002860833)
<!-- VERSION_INFO_END -->
...
- Simplification of the initial run-up (see: [Container runner script](./run.sh), [GitHub Copilot setup](./.copilot/config.json), [Environment configuration](./.copilot/.env))
...
- 🤖 [Supported AI Models](https://docs.github.com/en/copilot/reference/ai-models/supported-models#model-retirement-history)
  - **Recommended models**:
    ...
    - <span style="color: #a371f7;">**OpenAI GPT 5.5**</span> - [Documentation](https://openai.com/index/introducing-gpt-5-5/): Low, Medium, High, Extra High
  - **Effective Prompting**:
...
- [skill](.copilot/skills/sequential-thinking/SKILL.md)
...
- [skill](.copilot/skills/doc-search/SKILL.md)
...
- [skill](.copilot/skills/web-search/SKILL.md)
...
- [agent](.copilot/agents/postgres.agent.md)
- [skill](.copilot/skills/postgres/SKILL.md)
...
| test | production |
| -----|------------|
| [agent](.copilot/agents/grafana-tst.agent.md) | [agent](.copilot/agents/grafana-prd.agent.md) |
| [skill](.copilot/skills/grafana-tst/SKILL.md) | [skill](.copilot/skills/grafana-prd/SKILL.md) |
- **Documentation:** [Grafana MCP Server](https://github.com/grafana/mcp-grafana)

#### **graylog** - <span style="color: #d73a49;">Graylog</span>
| test | production |
| -----|------------|
| [agent](.copilot/agents/graylog-tst.agent.md) | [agent](.copilot/agents/graylog-prd.agent.md) |
| [skill](.copilot/skills/graylog-tst/SKILL.md) | [skill](.copilot/skills/graylog-prd/SKILL.md) |
...
| [`build.sh`](./build.sh) | <span style="color: #1a7f37;">Standalone container local build script</span> |
| [`run.sh`](./run.sh) | <span style="color: #1a7f37;">Standalone container local run script</span> |
| [`act.sh`](./act.sh) | <span style="color: #1a7f37;">[Act](https://github.com/nektos/act) tool wrapper script</span> |
| [`docker-image-native-multiplatform-pipeline.yaml`](.github/workflows/docker-image-native-multiplatform-pipeline.yaml) | <span style="color: #1a7f37;">GitHub Action pipeline workflow for native build (triggered on repository_dispatch)</span> |
| [`docker-image-emulated-multiplatform-pipeline.yaml`](.github/workflows/docker-image-emulated-multiplatform-pipeline.yaml) | <span style="color: #1a7f37;">GitHub Action pipeline workflow for emulated (QEMU ARM64) build</span> |
| [`monitor-release.yaml`](.github/workflows/monitor-release.yaml) | <span style="color: #1a7f37;"> GitHub Action workflow for monitoring of newest GitHub Copilot CLI versions</span> |
...
- [Awsome agent skills](https://github.com/VoltAgent/awesome-agent-skills)
- [Awsome MCP servers](https://github.com/punkpeye/awesome-mcp-servers/)
