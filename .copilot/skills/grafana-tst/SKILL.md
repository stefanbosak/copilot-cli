...
compatibility: Requires grafana-tst agent (.copilot/agents/grafana-tst.agent.md) and grafana-tst MCP server.
---
...
Tell Copilot: *"Use the grafana-tst agent to complete this task."*
